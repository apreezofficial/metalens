          ...
          {readyItems.length > 0 && (
            <div className="flex gap-2">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg border border-border bg-card px-4 py-2 text-sm font-medium hover:border-zinc-600"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-accent px-4 py-2 text-sm font-medium text-white hover:bg-blue-600"
              >
